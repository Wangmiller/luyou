...
app.post('/', function(req, res) {
  ...
  var sql = "select 'line' as type,'Total amount' as stack,year(create_dt) as yyyy,month(create_dt) as mm, count(*) as value, industry_label as name from v_product_industry " +
