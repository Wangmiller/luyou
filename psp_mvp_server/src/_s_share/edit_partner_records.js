...
app.post('/', function(req, res) {
  ...
  req.on('end', function () {
    var addSql = "update partner_visit_record set partner_sn = ?,visitor = ?,content = ?,visit_date = ? where id = ?";
    params = querystring.parse(params);
    var addSqlParams = [params.partner_sn, params.visitor, params.content, params.visit_date, params.id];
    // 设置响应头部信息及编码
