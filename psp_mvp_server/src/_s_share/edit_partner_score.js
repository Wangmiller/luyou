...
app.post('/', function(req, res) {
  ...
  req.on('end', function () {
    var addSql = "update partner_score " +
        "set product_concept = ?,product_concept_des = ?,just_need = ?,just_need_des = ?," +
        ...
        "planning_interaction_des = ?,investment_situation = ?,investment_situation_des = ?,total_score = ? where partner_sn = ?" ;
    params = querystring.parse(params);
    var addSqlParams = [params.product_concept, params.product_concept_des, params.just_need,
        ...
        params.investment_situation_des, params.total_score, params.partner_sn, ];
    // 设置响应头部信息及编码
