...
export class EnterpriseEditService {
  ...
  setX(data: any): XEnterprise {
    ...
    x.acc_year_last = data['acc_year_last'];
    ...
    x.other_insured_num = data['other_insured_num'];
    x.other_tax_level = data['other_tax_level'];
    x.other_taxpayer_aptitude = data['other_taxpayer_aptitude'];
