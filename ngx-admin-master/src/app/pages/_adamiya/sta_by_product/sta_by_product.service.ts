...
export class STAByProductService {
  ...
  getDSTA(sn): Promise<XSTAProduct[]> {
    const url = '/_s_adamiya/get_sta_product';
  ...
  setXSTA(data: any): XSTAProduct {
    const x = new XSTAProduct();
    x.this_year_product_industry_count = data['this_year_product_industry_count'];
    x.this_year_product_scene_count = data['this_year_product_scene_count'];
    x.this_year_product_count = data['this_year_product_count'];
    x.all_product_count = data['all_product_count'];
    x.last_year_product_count = data['last_year_product_count'];
