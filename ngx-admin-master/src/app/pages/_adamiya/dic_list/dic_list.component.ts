...
import {DicListService} from './dic_list.service';
import {XKV} from '../../@xmodel/XKV';
import {ActivatedRoute, Params} from '@angular/router';

@Component({
  selector: 'ngx-adamiya-dic-list',
  templateUrl: './dic_list.html',
  styles: [`
    nb-card {
...
export class DicListComponent implements OnInit, DoCheck {
  ...
  constructor(private service: DicListService, private route: ActivatedRoute) {
    this.ennew = '0';
    this.en = '0';
  }
